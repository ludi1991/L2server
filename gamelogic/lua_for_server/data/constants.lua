...
SPELL_BOOK_ITEM_ID = 1600001
KEY_ITEM_ID = 1400001
BATTERY_ITEM_ID = 1400002
LAB_MATERIAL_ITEM_IDS = {1400003, 1400004, 1400005}
...
EQUIP_COLOR_TBL = {cc.c3b(0,175,64),cc.c3b(0,118,169),cc.c3b(156,58,180),cc.c3b(238,118,36),cc.c3b(0,0,0)}
...
LAB_QUICK_HARVEST_COST = {10, 20, 30} --立刻完成消耗钻石
EQUIP_HOLE_COST = {3000, 10000, 30000, 80000} --打孔消耗金币
