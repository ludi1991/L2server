...
---------------------------
local value_list = {} 
value_list[1] = {id = 1, classification = 1, speaker = "model", showName = "guide", icon = "6", expression = nil, dec = "欧尼酱，你醒啦，真是担心死我了，都晕过去好几天了。", skip = 1}
...
value_list[4] = {id = 4, classification = 3, speaker = "model", showName = "guide", icon = "0", expression = nil, dec = "艾丝姐姐独自一人去无尽之塔去探索魔龙的线索了。", skip = 1}
...
value_list[6] = {id = 6, classification = 3, speaker = "model", showName = "guide", icon = "3", expression = nil, dec = "我担心她的危险(⊙?⊙)，咱们快过去找她吧！", skip = 1}
