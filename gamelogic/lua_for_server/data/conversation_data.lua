...
value_list[5] = {id=5,classification=3,speaker="model",showName="guide",icon="1",expression=nil,dec="还好右上角的战斗雷达可以实时看到艾丝姐姐的战况",skip=nil,}
value_list[6] = {id=6,classification=3,speaker="model",showName="guide",icon="6",expression=nil,dec="我担心她的危险(⊙ˍ⊙)，咱们快过去找她吧！",skip=1,}
